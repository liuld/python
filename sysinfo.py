...
device_white = ['em1', 'em2', 'eth0', 'eth1', 'eth2', 'eth3', 'bond0', 'bond1']
...
def run():
    ...
    if data['server_type'] in ['virtualbox', 'kvm']:
        data['vm_status'] = 1
    else:
        data['vm_status'] = 0
    send(data)
...
def send(data):
    url = "http://192.168.10.10:9000/resources/server/report/"
